...
<html>
<head>
<title>Travels a Travel Category Flat Bootstrap Responsive Website Template | About :: w3layouts</title>
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.jsp">Green <span>Wheels</span></a>	
		</div>
		<div class="bus wow fadeInUp animated" data-wow-delay=".5s">
            <a href="index.jsp" class="buses active">BUSES</a>
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							<li class="active"><a href="about.jsp">About</a></li>
								...
								<li><a href="agent.jsp">Agent Registration</a></li>
...
<div class="banner-1">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Travels - Best in Class for Travel & Hotels</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- about ---->
...
<div class="footer-top">
	<div class="container">
		<div class="col-md-6 footer-left wow fadeInLeft animated" data-wow-delay=".5s">
			<h3>Bus Operators</h3>
				<ul>
					<li><a href="bus.jsp">New York  Charter </a></li>
					<li><a href="bus.jsp">Washington Charter</a></li>
					<li><a href="bus.jsp">Los Angeles Charter</a></li>
					<li><a href="bus.jsp">Chicago Charter</a></li>
					<li><a href="bus.jsp">Orlando Charter</a></li>
					<li><a href="bus.jsp">New Orleans Charter</a></li>
					<li><a href="bus.jsp">Houston Charter</a></li>
					<li><a href="bus.jsp">Nashville Charter</a></li>
					<li><a href="bus.jsp">Charlotte Charter</a></li>
					<li><a href="bus.jsp">Toronto Charter</a></li>
					<li><a href="bus.jsp">Washington Charter</a></li>
					<li><a href="bus.jsp">Los Angeles Charter</a></li>
					<li><a href="bus.jsp">Chicago Charter</a></li>
					<li><a href="bus.jsp">Orlando Charter</a></li>
		...
		<div class="col-md-6 footer-left wow fadeInRight animated" data-wow-delay=".5s">
			<h3>Bus Routes</h3>
				<ul>
					<li><a href="travels.jsp">Alabama-California</a></li>
					<li><a href="travels.jsp">Alaska-Colorado</a></li>
					<li><a href="travels.jsp">Arizona-Delaware</a></li>
					<li><a href="travels.jsp">Arkansas-Florida</a></li>
					<li><a href="travels.jsp">Kansas-Georgia</a></li>
					<li><a href="travels.jsp">Iowa-Hawaii</a></li>
					<li><a href="travels.jsp">Indiana-Illinois</a></li>
					<li><a href="travels.jsp">Illinois-Florida</a></li>
					<li><a href="travels.jsp">Idaho-Indiana</a></li>
					<li><a href="travels.jsp">Hawaii-Iowa</a></li>
					<li><a href="travels.jsp">Georgia-Kansas</a></li>
					<li><a href="travels.jsp">Florida-Arkansas</a></li>
					<li><a href="travels.jsp">Delaware-Arizona</a></li>
					<li><a href="travels.jsp">Colorado-Alaska</a></li>
					<li><a href="travels.jsp">California-Alabama</a></li>
					<div class="clearfix"></div>
				</ul>
		</div>
		<div class="clearfix"></div>
...
<div class="copy-right">
	<div class="container">
		...
		<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© 2016 Travels . All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
	</div>
</div>
<!--- /copy-right ---->
<!-- sign -->
